...
import frc.auto.programs.ExampleAutoProgram;
import frc.auto.programs.StraightAndShoot;
import frc.auto.programs.StraightGetBallShoot;
...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        core.createInputs(SBInputs.values());
        core.createOutputs(SBOutputs.values());
        core.createSubsystems(SBSubsystems.values());

        AutoManager.getInstance().addProgram(new ExampleAutoProgram());
        AutoManager.getInstance().addProgram(new StraightAndShoot());
        AutoManager.getInstance().addProgram(new StraightGetBallShoot());
